...
alter table Members.juvenile
	 with check
	add constraint fk_juvenile_member_member_no foreign key (member_no)
			references Members.member (member_no);
go

alter table Members.juvenile
	 with check
	add constraint fk_juvenile_member_adult_member_no foreign key (adult_member_no)
			references Members.member (member_no);
go

alter table Members.adult
	 with check
	add constraint fk_jadult_member_member_no foreign key (member_no)
			references Members.member (member_no);
go
*/
