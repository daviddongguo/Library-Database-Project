--- loan != loan_data
--- missing with statement from adult table
--- missing a 'c' in the in_date portion of loanhistory [ '9' != 'c9'  ]
...
from													'C:\0_Dongguo_Database\member_data.txt'
WITH
(
	FIELDTERMINATOR =	'\t',
    ROWTERMINATOR	=	'\n'
...
BULK INSERT tmptable  
from														'C:\0_Dongguo_Database\adult_data.txt'
with
(
	FIELDTERMINATOR =	'\t',
    ROWTERMINATOR	=	'\n'
...
BULK INSERT tmptable  
from														'C:\0_Dongguo_Database\juvenile_data.txt'
...
from														'C:\0_Dongguo_Database\item_data.txt'
WITH 
   (
	 FIELDTERMINATOR =	'\t',
     ROWTERMINATOR	=	'\n'
...
from														'C:\0_Dongguo_Database\copy_data.txt'
WITH 
   (
	 FIELDTERMINATOR =	'\t',
     ROWTERMINATOR	=	'\n'
...
from														'C:\0_Dongguo_Database\reservation_data.txt'
WITH
(
       FIELDTERMINATOR =    '\t',
       ROWTERMINATOR =      '\n'
...
from														'C:\0_Dongguo_Database\loan_data_new.txt'
WITH
(
	FIELDTERMINATOR =	'\t',
    ROWTERMINATOR	=	'\n'
...
BULK INSERT tbl_temp
FROM													'C:\0_Dongguo_Database\loanhist_data_new.txt'
WITH
(
	FIELDTERMINATOR =	'\t',
    ROWTERMINATOR	=	'\n'
